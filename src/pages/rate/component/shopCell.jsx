...
export default class Cell extends Component {
  ...
  renderText(p1, p2, img, content, noMr, style) {
    return (
      <div
        className={noMr ? `flex-column sp-8` : `flex-column mr-60`}
        style={style}
      >
        <div className={"flex-row mb-15"} style={{ alignItems: "center" }}>
          <p className={"p4"} style={{ fontSize: "0.18rem" }}>
            {p1}
          </p>
          {img ? (
            <Popover trigger="hover" content={content}>
              <img
                src={require("../../../images/rate/info.png")}
                alt=""
                className={"img-info"}
              />
            </Popover>
        ...
        <div className={"p5"} style={{ color: "#24375E", fontSize: "0.22rem" }}>
          {p2}
        </div>
      </div>
    );
  ...
  renderList() {
    ...
    return (
      <div
        className={`${pre}-cell mt-20 ${styles.rateCell} ${
          this.props.status === 3 ? styles.notAllow : ""
        }`}
        style={{ height: "auto", maxHeight: "initial", paddingBottom: "60px" }}
      >
        ...
        <div className={`flex-row-center ${styles.flexRowCenter}`}>
          <div
            className={"flex-row"}
            style={{ marginTop: "0", width: "100%", paddingLeft: "80px" }}
          >
            <div
              className={`flex-column rate-cell-content ${styles.rateCellContent}`}
              onClick={() => {
                this.props.checkDetail &&
                  this.props.checkDetail(this.state.amount);
              }}
            >
              ...
              {this.props.type === 4 ? (
                <div className={"flex-row mt-15"}>
                  <p className={"p2"} style={{ color: "#86929D" }}>
                    {this.props.slogan}
                  </p>
                </div>
              ) : (
                ...
                >
                  <p
                    className={`p2 ${styles.maxTitle}`}
                    style={{ color: "#86929D" }}
                    title={this.props.slogan}
                  >
                    {this.props.slogan}
                  </p>
                  <div
                    className={"sp-5"}
                    style={{ background: "#86929D" }}
                  ></div>
                  <div
                    className={"p2"}
                    onClick={() => {
              ...
              <div className={"flex-row mt-30"}>
                {this.renderText(
                  intl.get("RATE_50"),
                  this.props.contractDuration + intl.get("RATE_23"),
                  true,
                  intl.get("RATE_52"),
                  true,
                  { width: "2rem" }
                ...
                {this.renderText(
                  intl.get("RATE_51"),
                  (this.props.serviceChargeRate * 100).toFixed(2) + "%",
                  true,
                  intl.get("RATE_53"),
                  true,
                  { width: "4rem" }
              ...
              {this.props.locale === "en" ? (
                <img
                  src={require("@/images/home/home_icon_pre_sale_1.png")}
                  className={`${styles.contentItemImg}`}
                  alt=""
                />
              ) : (
                <img
                  src={require("@/images/home/home_icon_pre_sale_2@2x.png")}
                  className={`${styles.contentItemImg}`}
                  alt=""
                />
              )}
            ...
            <div className={"flex-column"} style={{ marginLeft: "100px" }}>
              ...
              <div
                className={"flex-row mb-10 mt-10"}
                style={{ alignItems: "flex-end" }}
              >
                <p className={"p6"}>
                  <span className={"sp-7"} style={{ color: "#575C62" }}>
                    {intl.get("RATE_2")}
                  </span>{" "}
                  {(this.props.price * this.state.amount).toFixed(2)} USDT
                </p>
              </div>
              ...
              <div style={{ textAlign: "center" }}>
                <Button
                  onClick={() => {
                    if (this.state.minLimit > this.state.amount) {
                      message.info(
                        intl.get("RATE_1", { limit: this.state.minLimit }),
                        1,
                        () => {}
      ...
      <div className={`${pre}-h5-cell`} style={{ height: "76vw" }}>
        ...
        <div className={"content"}>
          ...
          {this.props.type === 5 ? (
            <div
              className={"flex-row"}
              style={{ alignItems: "center", margin: "3vw 0" }}
            >
            ...
            >
              ...
              <p
                className={"p2"}
                onClick={() => this.props.onClick(this.state.amount)}
              >
                {intl.get("RATE_82")}
              </p>
            </div>
                ...
                <div style={{ width: "50%" }}>
                  <div className={"flex-row"} style={{ alignItems: "center" }}>
                    ...
                    <img
                      ...
                      alt=""
                      className={"img-info"}
                      onClick={() => message.info(intl.get("RATE_52"), 1)}
                    />
                  </div>
                  <div className={"p4"}>
                    {this.props.contractDuration}
                    {intl.get("RATE_23")}
                  </div>
                </div>
                <div>
                  <div className={"flex-row"} style={{ alignItems: "center" }}>
                    ...
                    <img
                      ...
                      alt=""
                      className={"img-info"}
                      onClick={() => message.info(intl.get("RATE_53"), 1)}
                    />
                  </div>
                  <div className={"p4"}>
                    {(this.props.serviceChargeRate * 100).toFixed(2)}%
          ...
          <div className={"flex-row-between"} style={{ marginBottom: "4vw" }}>
            <div className={"flex-row"} style={{ alignItems: "flex-end" }}>
              <div className={"p5"}>
                <span style={{ fontSize: "3vw" }}>{intl.get("RATE_2")}</span>${" "}
                {(this.props.price * this.state.amount).toFixed(2)}
              </div>
            </div>
            <div className={"flex-row"} style={{ alignItems: "center" }}>
              <div
          ...
          <div className={"flex-row-between"} style={{ marginTop: "3vw" }}>
            <div className={"flex-row"} style={{ alignItems: "center" }}>
              <p className={"p3"} style={{ marginRight: "2vw" }}>
                {intl.get("RATE_18")}{" "}
              </p>
              <div className={"flex-row"}>
                {this.props.support.map((item, index) => {
        ...
        <div className={"content"}>
          ...
          <div className={"flex-row"}>
            ...
            <div>
              ...
              <div
                className={"flex-row"}
                style={{ alignItems: "flex-end", marginBottom: "3vw" }}
              >
          ...
          <div className={"progress"}>
            ...
            <div className={"p6"}>
              {intl.get("RATE_47")}
              {`${(
                ((this.props.status === 3 ? 0 : this.props.remainingQuantity) /
                  this.props.quantity) *
                100
              ).toFixed(2)}%`}
            </div>
  ...
  renderDetail() {
    return (
      <div
        className={`${pre}-cell mt-20`}
        style={{ minHeight: "2.13rem", maxHeight: "2.84rem" }}
      >
        <span className={"flag"}>{this.props.tag}</span>
        <div className={"flex-row-center"}>
          <div className={"flex-row mt-10"}>
            ...
            <div className={"flex-column"}>
              ...
              <div
                className={"flex-row mb-20 mt-15"}
                style={{ alignItems: "flex-end" }}
              >
  ...
  render() {
    return (
      <div>
        ...
        {this.props.type === 2 || this.props.type === 5
          ? this.renderListH5()
          : null}
